...
<div class="main" style="height: 900px">
    ...
    <div class="main-right" id="buy_person" style="height: 900px">
        ...
        <a href="order_BuyModule.action"><h3 style="display: inline-block"><span class="overview" style=" margin-left: 35px">myBuyModule</span></h3></a>
        <a href="code_market.action" title="To Buy codeModule" target="_blank"><img
        ...
        <div style="overflow: hidden" class="CodeModule">
            ...
            <c:forEach items="${pageBean.pageList}" var="code">
                <div class="repositories-1" style="height:95px">
                    <a href="code_ViewCode.action?id=${code.codeModule.id}" target="_blank">${code.codeModule.code_name}</a>
                    ...
                    <div class="management">
                        <a href="code_ViewCode.action?id=${code.codeModule.id}" target="_blank">View</a>
                    </div>
                </div>
            </c:forEach>
            <div class="pagepage">
...
<script>
    ...
    $(".page_div").paging({
            ...
            callback: function (num) {
                window.location.href = "order_BuyModule.action?currentPage=" + num;
            }
        }
    )
    $(function () {
