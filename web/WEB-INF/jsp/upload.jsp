...
<div class="center" style="margin:100px auto 0;width: 650px;height: 1270px;">
    <form id="form_build" action="code_SaveCodeModule.action" method="post" enctype="multipart/form-data">
        <h3><span class="overview">Upload codeModule</span></h3>
        ...
        <div>
            ...
            <div class="repositories-1">
                <p>Keyword:</p>
                <div class="keyword">
                    <input type="text" id="keyword" name="keyword1" placeholder="keyword1">
            ...
            <div class="repositories-1" style="height:400px">
                ...
                <textarea id="info" name="info" style="height: 330px;width: 550px;resize: none;"
                          placeholder="Please input detailed introduction..."></textarea>
            </div>
        </div>
        <div class="repositories-1">
            <p>Code File:</p>
            ...
            <span style="margin-left: 120px;color: #3F51B5" id="filename"></span>
        </div>

        <div style="display:inline-block;margin-top: 20px">
            <input type="submit" class="save" style="width:200px;margin-left: 55px" value="Submit" id="saveCode">
            <input type="reset" class="save" value="Reset"
