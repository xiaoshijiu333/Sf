...
<div class="center">
    <div class="center_top" style="color: #15192E">CONTACT&nbsp;&nbsp;&nbsp;&nbsp; US</div>
    <div class="center_center">
        <div class="center_left">
            <img src="images/location.png" alt="">
            <div class="our">OUR FACTORY</div>
            <div class="easy">8 The Green #4638</div>
            <div class="easy">Dover, DE, 19901</div>
            <div class="easy">flowers@mockingbot.com | Tel. 123-456-7890</div>
            <div class="map">View Map ></div>
        </div>
        <div class="center_right">
            <img src="images/clock.png" alt="" style="height: 30px">
            <div class="our">OPENING HOURS</div>
            <div class="easy">Monday - Friday: 11.00 - 18.30</div>
            <div class="easy">Saturday: 11.00 - 17.00</div>
            <div class="easy">Sunday: 12.30 - 16.30</div>
        </div>
    </div>
    <div class="center_bottom">
        <div class="bottom_top">You can also email us at: flowers@mockingbot.com or fill in our contact form:</div>
        <div class="form">
            <form action="">
